...
public abstract class AbstractSonars extends QActor { 
	...
	protected IActorAction action;
		...
		public AbstractSonars(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/sonars/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");
			this.planFilePath = "./srcMore/it/unibo/sonars/plans.txt";
	  	}
		@Override
		...
		*/    
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("init",-1);
	    	...
	    	temporaryStr = "\"Sonars STARTED\"";
	    	println( temporaryStr );  
	    	//switchTo waitingForCollision
	        switchToPlanAsNextState(pr, myselfName, "sonars_"+myselfName, 
	    ...
	    try{	
	     ...
	     pr.incNumIter(); 	
	    	...
	    	//bbb
	     msgTransition( pr,myselfName,"sonars_"+myselfName,false,
	          new StateFun[]{stateTab.get("handleEvent") }, 
	          new String[]{"true","M","internalsonar" },
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("handleEvent",-1);
	    	...
	    	if( currentMessage != null && currentMessage.msgId().equals("internalsonar") && 
	    		pengine.unify(curT, Term.createTerm("sonar(NAME,PLAYER,DISTANCE)")) && 
	    		pengine.unify(curT, Term.createTerm( currentMessage.msgContent() ) )){ 
	    		String parg="cmd(sonar2s,sonar2,detectedbysonar2)";
	    		/* RaiseEvent */
	    		parg = updateVars(Term.createTerm("sonar(NAME,PLAYER,DISTANCE)"),  Term.createTerm("sonar(sonar2,player,0)"), 
	    			    		  					Term.createTerm(currentMessage.msgContent()), parg);
	    		if( parg != null ) emit( "sonarEvent", parg );
	    	}
	    	repeatPlanNoTransition(pr,myselfName,"sonars_"+myselfName,false,true);
