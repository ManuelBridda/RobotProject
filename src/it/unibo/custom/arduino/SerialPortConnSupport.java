...
//private BufferedReader input;
	...
	public void sendCmd(String msg) throws Exception {
		println("INVIATO: "+ Arrays.toString(msg.getBytes()));
...
//		println("SerialPortConnSupport has sent   " + msg);
	...
	public void clearQ() {
 	...
 	@Override 
	public synchronized String receiveALine() throws Exception { 	//synchronized
	...
	protected synchronized void updateLines(String data){ //synchronized
