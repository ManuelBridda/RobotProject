%==============================================
% WorldTheory.pl for actor conditioncontrol
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuconditioncontrol).	%%old version (deprecated)
actorobj(qatuconditioncontrol).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor conditioncontrol
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of conditioncontrol" ). 
...
%-------------------------------------------------
%  User static rules about conditioncontrol
%------------------------------------------------- 
/*
------------------------------------------------------------------------
