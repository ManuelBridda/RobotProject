%==============================================
% WorldTheory.pl for actor clocksensor
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuclocksensor).	%%old version (deprecated)
actorobj(qatuclocksensor).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor clocksensor
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of clocksensor" ). 
...
%-------------------------------------------------
%  User static rules about clocksensor
%------------------------------------------------- 
/*
------------------------------------------------------------------------
