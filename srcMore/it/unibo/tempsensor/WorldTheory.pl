%==============================================
% WorldTheory.pl for actor tempsensor
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatutempsensor).	%%old version (deprecated)
actorobj(qatutempsensor).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor tempsensor
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of tempsensor" ). 
...
%-------------------------------------------------
%  User static rules about tempsensor
%------------------------------------------------- 
/*
------------------------------------------------------------------------
