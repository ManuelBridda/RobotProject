%==============================================
% WorldTheory.pl for actor sonars
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatusonars).	%%old version (deprecated)
actorobj(qatusonars).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor sonars
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of sonars" ). 
...
%-------------------------------------------------
%  User static rules about sonars
%------------------------------------------------- 
/*
------------------------------------------------------------------------
