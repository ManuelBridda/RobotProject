%==============================================
% WorldTheory.pl for actor sonarr
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatusonarr).	%%old version (deprecated)
actorobj(qatusonarr).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor sonarr
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of sonarr" ). 
...
%-------------------------------------------------
%  User static rules about sonarr
%------------------------------------------------- 
/*
------------------------------------------------------------------------
