%==============================================
% WorldTheory.pl for actor obstacledemo
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuobstacledemo).	%%old version (deprecated)
actorobj(qatuobstacledemo).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor obstacledemo
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of obstacledemo" ). 
...
%-------------------------------------------------
%  User static rules about obstacledemo
%------------------------------------------------- 
/*
------------------------------------------------------------------------
